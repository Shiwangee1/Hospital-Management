<nav class="navbar navbar-expand-lg navbar-light bg-info">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp">MEDI HOME <i class="fa-solid fa-house-medical"></i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="Docter_login.jsp">DOCTER</a>
        </li>
        
        <!--  <li class="nav-item">
          <a class="nav-link" href="UserAppointtment.jsp">APPOITTNMENT</a>
        </li> -->
